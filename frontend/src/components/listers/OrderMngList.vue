        ...
        <v-col style="margin-bottom:40px;">
            <div class="text-center">
                ...
                >
                    ...
                    <OrderMng :offline="offline" class="video-card" :isNew="true" :editMode="true" v-model="newValue" @add="append" v-if="tick"/>
...
<script>
    ...
    export default {
        ...
        async created() {
            ...
            temp.data._embedded.ordermngs.map(obj => obj.id=obj._links.self.href.split("/")[obj._links.self.href.split("/").length - 1])
