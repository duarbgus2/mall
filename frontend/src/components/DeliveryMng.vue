<template>
    ...
    <v-card style="width:450px;" outlined>
        ...
        <v-card-title v-if="value._links">
            DeliveryMng # {{value._links.self.href.split("/")[value._links.self.href.split("/").length - 1]}}
        </v-card-title >
        <v-card-title v-else>
            DeliveryMng
        </v-card-title >
        ...
        <v-card-text>
            ...
            <String label="PorductId" v-model="value.porductId" :editMode="editMode"/>
        ...
        methods: {
            ...
            async save(){
                try {
                    ...
                    if(!this.offline) {
                        if(this.isNew) {
                            temp = await axios.post(axios.fixUrl('/deliveryMngs'), this.value)
                        } else {
