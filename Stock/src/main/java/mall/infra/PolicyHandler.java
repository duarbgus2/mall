...
public class PolicyHandler{
    @Autowired StockMngRepository stockMngRepository;
    ...
    public void wheneverDeliveryCanceled_StockIncrease(@Payload DeliveryCanceled deliveryCanceled){
